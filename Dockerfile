...
ADD ./target/uberjar/planwise-0.5.1-standalone.jar /app/lib/
ENV JAR_PATH /app/lib/planwise-0.5.1-standalone.jar
...
CMD ["java", "-jar", "/app/lib/planwise-0.5.1-standalone.jar"]
