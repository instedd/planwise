...
-- function moved to resources/planwise/plpgsql/

-- generates the isochrone polygons for all thresholds for a single facility
-- DROP FUNCTION process_facility_isochrones(f_id bigint, _method varchar, threshold_start integer, threshold_finish integer, threshold_jump integer);
